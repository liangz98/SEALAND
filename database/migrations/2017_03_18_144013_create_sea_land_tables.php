...
class CreateSeaLandTables extends Migration {
    ...
    public function up() {
        ...
        Schema::create('training_type', function (Blueprint $table) {
            ...
            $table->string('en_name')->nullable();      // 分类英文名
        ...
        Schema::create('training', function (Blueprint $table) {
            ...
            $table->string('en_location', 128)->nullable();
            ...
            $table->boolean('deleted')->default(false);         // 是否删除,default: false
            $table->string('status', 2);                        // 状态,[01: 有效(接受报名), 02: 禁用]
            $table->integer('created_by')->default(0);          // 创建人
            $table->integer('last_updated_by')->default(0);     // 最后更新人
            $table->timestamps();
        });
        ...
        Schema::create('register_course', function (Blueprint $table) {
            ...
            $table->boolean('deleted')->default(false);         // 是否删除,default: false
            $table->string('status', 2)->default('02');         // 状态,[01: 审核通过, 02: 申请, 03: 拒绝, 04: 取消(或关闭)
                                                                // 05: 培训完成]
            $table->integer('created_by')->default(0);          // 创建人
            $table->integer('last_updated_by')->default(0);     // 最后更新人
            $table->timestamps();
        ...
        Schema::create('product', function (Blueprint $table) {
            ...
            $table->string('en_name', 128);
            $table->string('number', 128);                      // 产品编号
            $table->string('pricing_unit', 8)->nullable();      // 定价单位
            $table->decimal('unit_price', 18, 4);               // 单价
            $table->string('desc')->nullable();                 // 描述
            $table->string('en_desc')->nullable();
            $table->boolean('deleted')->default(false);         // 是否删除,default: false
            $table->string('status', 2);                        // 状态,[01: 有效, 02: 禁用]
